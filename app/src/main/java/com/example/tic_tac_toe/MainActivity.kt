...
import com.example.tic_tac_toe.presentation.TicTacToeField
import com.example.tic_tac_toe.presentation.TicTacToeViewModel
            ...
            TicTacToeTheme {
                ...
                if (showConnectionError) {
                    ...
                    Box(
                        ...
                        if (
                            state.connectedPlayers.size == 2 && state.winningPlayer == null && !state.isBoardFull
                        ) {
                            Text(
